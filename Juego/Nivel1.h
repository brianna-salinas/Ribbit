...
namespace Juego {
	...
	public ref class Nivel1 : public Form {
		...
		int tiempoRestante; // **300 segundos = 5 minutos**
	...
	public:
		Nivel1(String^ nombreJugador, int skin) {
			InitializeComponent();
			PlaySound(L"img//musica//Nivel1.wav", NULL, SND_ASYNC | SND_LOOP);
			...
			juego = gcnew ControladorNivel1(4, 300, nombreJugador, skin); // PASAR SKIN
			// **Crear temporizador independiente**
			temporizador = gcnew System::Windows::Forms::Timer();
			temporizador->Interval = 1000; // **Cada 1 segundo**
			temporizador->Tick += gcnew System::EventHandler(this, &Nivel1::Temporizador_Tick);
			temporizador->Start();
	...
	private:
		void InitializeComponent(void) {
			...
			this->clock->Tick += gcnew System::EventHandler(this, &Nivel1::clock_Tick);
			// 
			// Nivel1
			// 
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Nivel1::Nivel1_FormClosing);
			...
			this->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Nivel1::Nivel1_MouseMove);
		...
		Void Nivel1_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e) {
			if (clock->Enabled) {
				clock->Stop();
		...
		Void clock_Tick(Object^ sender, EventArgs^ e) {
			...
			if (juego->GetJugadorVidas() == 0 || tiempoRestante == 0) {
				clock->Stop();
		...
		Void Nivel1_KeyUp(Object^ sender, KeyEventArgs^ e) {
